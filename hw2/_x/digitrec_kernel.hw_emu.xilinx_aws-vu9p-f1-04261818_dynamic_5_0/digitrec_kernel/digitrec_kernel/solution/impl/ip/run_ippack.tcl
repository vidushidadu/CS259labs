...
set Library     "hls"
set IPName      "digitrec_kernel"
set Version     "1.0"
set DisplayName "Digitrec_kernel"
set Revision    "1810250031"
...
set sdx_kernel_files {/home/centos/src/project_data/aws-fpga/SDAccel/examples/xilinx_2018.2/getting_started/cs-259-18f/hw2/digitrec.cpp}
set enable_xo_gen 1

## Variables
set Top "digitrec_kernel_digitrec_kernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 test_image_1 W 0x0 "Data signal of test_image" {{0 32 test_image W 0 "Bit 31 to 0 Data signal of test_image"}}} {0x14 test_image_2 W 0x0 "Data signal of test_image" {{0 32 test_image W 0 "Bit 63 to 32 Data signal of test_image"}}} {0x1c train_images_1 W 0x0 "Data signal of train_images" {{0 32 train_images W 0 "Bit 31 to 0 Data signal of train_images"}}} {0x20 train_images_2 W 0x0 "Data signal of train_images" {{0 32 train_images W 0 "Bit 63 to 32 Data signal of train_images"}}} {0x28 knn_mat_1 W 0x0 "Data signal of knn_mat" {{0 32 knn_mat W 0 "Bit 31 to 0 Data signal of knn_mat"}}} {0x2c knn_mat_2 W 0x0 "Data signal of knn_mat" {{0 32 knn_mat W 0 "Bit 63 to 32 Data signal of knn_mat"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem m_axi_gmem2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 163863 II x}
