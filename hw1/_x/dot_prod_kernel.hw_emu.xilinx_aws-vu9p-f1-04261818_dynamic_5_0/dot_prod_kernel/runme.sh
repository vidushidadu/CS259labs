...
HD_PWD='/home/centos/src/project_data/aws-fpga/SDAccel/examples/xilinx_2018.2/getting_started/cs-259-18f/hw1/_x/dot_prod_kernel.hw_emu.xilinx_aws-vu9p-f1-04261818_dynamic_5_0/dot_prod_kernel'
cd "$HD_PWD"
...
EAStep vivado_hls -f dot_prod_kernel.tcl -messageDb vivado_hls.pb
